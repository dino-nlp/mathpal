class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "bf16[262400, 2048]", primals_2: "Sym(s0)", primals_3: "i64[1, s0]", primals_4: "Sym(s1)", primals_5: "i64[1, s1]", primals_6: "Sym(s3)", primals_7: "f32[1, s3, 2048]", primals_8: "i64[]"):
        ...
        slice_6: "i64[1, s0 - 1]" = torch.ops.aten.slice.Tensor(slice_scatter, 1, 0, -1)
        index_put: "i64[1, s0 - 1]" = torch.ops.aten.index_put.default(slice_6, [eq_14], full_default);  slice_6 = eq_14 = None
        slice_scatter_1: "i64[1, s0]" = torch.ops.aten.slice_scatter.default(slice_scatter, index_put, 1, 0, -1);  slice_scatter = index_put = None
        ...
        select_1: "i64[1]" = torch.ops.aten.select.int(slice_scatter_1, 1, -1)
        copy_1: "i64[1]" = torch.ops.aten.copy.default(select_1, full_default);  select_1 = full_default = None
        select_scatter: "i64[1, s0]" = torch.ops.aten.select_scatter.default(slice_scatter_1, copy_1, 1, -1);  slice_scatter_1 = copy_1 = None
        ...
        view_1: "f32[s3, 2048]" = torch.ops.aten.view.default(primals_7, [-1, 2048]);  primals_7 = None
