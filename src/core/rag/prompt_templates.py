...
class SelfQueryTemplate(BasePromptTemplate):
    ...
    The required information that needs to be extracted is the grade name or grade id. 
    Your response should consists of only the extracted grade name (e.g., grade_5) or id (e.g. 1345256), nothing else.
    If the user question does not contain any grade name or id, you should return the following token: none.
    
    For example:
    QUESTION 1:
    Tôi đang học lớp 5, tôi muốn ...
    RESPONSE 1:
    grade_5
    
    QUESTION 2:
    Tôi đang muốn tìm kiếm bài tập ...
    RESPONSE 2:
    none
    
    QUESTION 3:
    grade id của tôi là 1345256, tôi múôn tìm kiếm bài tập ...
    RESPONSE 3:
    1345256
